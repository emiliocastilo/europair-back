...
public interface AircraftRepository extends JpaRepository<Aircraft, Long>, IAircraftRepositoryCustom {
     ...
     @Query("select aircraft from Aircraft aircraft" +
             " join aircraft.bases base" +
             " join base.airport airport" +
             " join airport.country country" +
             " join aircraft.aircraftType aircraftType" +
             " join aircraftType.category category" +
             " join aircraftType.subcategory subcategory" +
             " join aircraft.operator operator" +
             " where" +
