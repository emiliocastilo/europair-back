...
public interface IStateChangeService {
    ...
    void changeState(@NotEmpty final List<Long> contractIds, final ContractStatesEnum state);
    ...
    boolean canChangeState(@NotNull final Contract contract, final ContractStatesEnum stateTo);
}
